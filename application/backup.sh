...
#dkn logger -p user.info "Started backup..."
...
#dkn logger -p user.info "Backup completed in $(expr ${end} - ${start}) seconds."
...
#dkn logger -p user.info "Backup pruning completed in $(expr ${end} - ${start}) seconds."
...
#dkn logger -p user.info "Repository check completed in $(expr ${end} - ${start}) seconds."
...
#dkn logger -p user.info "Repository unlock completed in $(expr ${end} - ${start}) seconds."
echo "restic-backup-restore: Repository unlock completed in $(expr ${end} - ${start}) seconds."

#dkn logger -p user.info "...completed backup."
